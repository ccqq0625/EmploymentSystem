<template>
    ...
    <header>
      <el-button type="primary" class="btn" @click="btn">返回首页</el-button>
        ...
        text-color="#fff">
        <el-submenu index="1">
            <template slot="title">年级选择</template>
            <el-menu-item index="/pro2017">2017</el-menu-item>
            <el-menu-item index="/pro2018">2018</el-menu-item>
            <el-menu-item index="/pro2019">2019</el-menu-item>
            <el-menu-item index="/pro2020">2020</el-menu-item>
        </el-submenu>
      </el-menu>
      </div>
      <h1>计算机工程学院就业情况</h1>
    ...
    tooltip: {
      ...
      formatter: function(params, ticket, callback) {
        if (params.seriesType == "effectScatter") {
          return "人数：" + params.data.name + "" + params.data.value[2];
...
Flexible(){
    flexible.flexible(window, document)
},
