...
import Pro20171 from './pro20171.vue'
...
export default {
    ...
    methods:{
         fecthData(){
          api.getToatlData(null,'17','计算机科学与技术',null).then(Response=>{
            //console.log("总体");
          ...
          api.getWorkData(null,'17','计算机科学与技术',null).then(Response=>{
           ...
           api.getOfficeData(null,'17','计算机科学与技术',null).then(Response=>{
            ...
            // 薪资
          api.getSalary(null,'17','计算机科学与技术',null).then(response => {
          ...
          //调用地区接口
          api.showAreaCount(null,'17','计算机科学与技术',null).then(response => {
            const resp4 = response.data
            this.areaData = resp4.data
            this.flag3=true
          })
          // 获取全院总人数和已就业人数
          api.digitalShow(null,'17','计算机科学与技术',null,'就业').then(response => {
