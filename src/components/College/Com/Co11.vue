...
<div class="containner">
     <div id="head">
        ...
        <el-breadcrumb class="title" separator="/">
          ...
          <el-breadcrumb-item><a href="/College/Com/Co1"><span style="font-size:20px">计算机科学与技术</span></a></el-breadcrumb-item>
          <el-breadcrumb-item><a href="#"><span style="font-size:20px">计科1711</span></a></el-breadcrumb-item>
        </el-breadcrumb>
    </div>
