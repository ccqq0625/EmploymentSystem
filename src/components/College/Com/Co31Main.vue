<template>
  <div>
    <Co31 v-if="flag1&&flag2&&flag3"  :datacwx="datacwx" :Legends="Legends" :seriesData="seriesData" :datacwx1="datacwx1" :Legends1="Legends1" :seriesData1="seriesData1" :datacwx2="datacwx2" :Legends2="Legends2" :seriesData2="seriesData2"></Co31>
  </div>
</template>

<script>
import echarts from 'echarts'
import Co31 from './Co31.vue'
...
export default {
  ...
  methods:{
      fecthData(){
          dataApi.fecth(null,null,'物联网1711').then(Response=>{
          ...
          dataApi.workFecth(null,null,'物联网1711').then(Response=>{
            ...
            dataApi.eduFecth(null,null,'物联网1711').then(Response=>{
