...
<div class="containner">
     <div id="head">
        <h1><strong>物联网1711就业情况</strong></h1>
        <el-breadcrumb class="title" separator="/">
          ...
          <el-breadcrumb-item><a href="#"><span style="font-size:20px">物联网1711</span></a></el-breadcrumb-item>
        </el-breadcrumb>
    </div>
    ...
    <el-row class="tac"> 
        ...
        @select="handleSelect">
           <el-menu-item index="/College/Com/Co3/Co31Main">
                <span slot="title">物联网1711</span>          
            </el-menu-item>
            <el-menu-item index="/College/Com/Co3/Co32Main">
                <span slot="title">物联网1712</span>            
            </el-menu-item>
        </el-menu>
    </el-col>
    </el-row>
