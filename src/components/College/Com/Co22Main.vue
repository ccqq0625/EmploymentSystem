<template>
  <div>
    <Co22 v-if="flag1&&flag2&&flag3"  :datacwx="datacwx" :Legends="Legends" :seriesData="seriesData" :datacwx1="datacwx1" :Legends1="Legends1" :seriesData1="seriesData1" :datacwx2="datacwx2" :Legends2="Legends2" :seriesData2="seriesData2"></Co22>
  </div>
</template>

<script>
import echarts from 'echarts'
import Co22 from './Co22.vue'
...
export default {
  ...
  methods:{
      fecthData(){
          dataApi.fecth(null,null,'软工1712').then(Response=>{
          ...
          dataApi.workFecth(null,null,'软工1712').then(Response=>{
            ...
            dataApi.eduFecth(null,null,'软工1712').then(Response=>{
